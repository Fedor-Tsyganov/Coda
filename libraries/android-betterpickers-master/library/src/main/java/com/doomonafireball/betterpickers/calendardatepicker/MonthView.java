...
public abstract class MonthView extends View {
    ...
    /**
     * Called when the user clicks on a day. Handles callbacks to the {@link com.doomonafireball.betterpickers.calendardatepicker.MonthView.OnDayClickListener} if one is set.
     *
